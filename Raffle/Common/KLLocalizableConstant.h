...
#define BUTTON_TITLE_DELETE_PHOTO_COUNT_ONE     NSLocalizedString(@"DeletePhotoCountOne", "")
#define BUTTON_TITLE_DELETE_PHOTO_COUNT_OTHER   NSLocalizedString(@"DeletePhotoCountOther", "")
